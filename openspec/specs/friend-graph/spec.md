...
The daily-questions feature SHALL NOT modify how friendships are created, updated, or removed.

#### Scenario: Friendship flows unaffected
- **WHEN** users add, confirm, or remove friendships through existing flows
- **THEN** the behavior and API contracts for those flows SHALL remain unchanged despite the introduction of daily-questions
